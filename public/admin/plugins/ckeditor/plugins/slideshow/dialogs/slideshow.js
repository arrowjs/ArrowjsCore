...
var IMG_PARAM = {
    ...
    SCRIPT_FLEX = pluginPath + "3rdParty/flexslider/jquery.flexslider-min.js",
    CSS_FLEX = pluginPath + "3rdParty/flexslider/flexslider.css";
...
CKEDITOR.dialog.add("slideshowDialog", function (f) {
    ...
    function x(a) {
        ...
        if (0 != a.imagesList.length) {
            ...
            var d = a.getContentElement("slideshowinfoid", "framepreviewid"), e = "", e = e + "<head>", e = e + ('<script src="' + SCRIPT_JQUERY + '" type="text/javascript"><\/script>'), e = e + ('<script type="text/javascript" src="' +
                SCRIPT_FLEX + '"><\/script>'), e = e + ('<link rel="stylesheet" type="text/css" href="' + CSS_FLEX + '" />');
    ...
    function v(a) {
        ...
        b = g.append("div");
        b.setAttribute("class", "flexslider");
        b.setAttribute("contenteditable", "false");
        b.setAttribute("id", d);
        d = b.append("div");
        d.setAttribute("class", "slides");
