                        ...
                        '<div class="modal-content col-md-12 col-sm-12">' +
                            '<div class=row>' +
                                '<div class="modal-header col-md-12 col-sm-12">' +
                                    ...
                                    '<h4 class="modal-title">Choose your avatar image</h4>' +
                                '</div>' +
                                '<div class="modal-body col-md-12 col-sm-12" id="avatar-body">' +
                                    '<ul class="nav nav-tabs" role="tablist" id="avt-tab">' +
                                        '<li role="presentation" class="active"><a href="#avt-gal-tab" aria-controls="avt-gal-tab" role="tab" data-toggle="tab">Choose from gallery</a></li>' +
                                        '<li role="presentation"><a href="#avt-upload-tab" aria-controls="avt-upload-tab" role="tab" data-toggle="tab">Upload avatar</a></li>' +
                                    '</ul>' +
                                    '<div class="tab-content">' +
                                        '<div role="tabpanel" class="tab-pane fade in active" id="avt-gal-tab">' +
                                            '<div id="avt-wrap"></div>' +
                                        '</div>' +
                                        '<div role="tabpanel" class="tab-pane fade in" id="avt-upload-tab">' +
                                            '<div id="image-cropper">' +
                                            '<!-- The preview container is needed for background image to work -->' +
                                                '<div class="select-btn-wrap">' +
                                                    '<a class="select-image-btn btn btn-primary"><i class="fa fa-upload"></i> Upload new image</a>' +
                                                    '<a class="save-image-btn btn btn-success"><i class="fa fa-save"></i> Save this avatar</a>' +
                                                '</div>' +
                                                ...
                                                '</div>' +
                                                '<div id="avt-upload-zone">' +
                                                    '<span class="help-block">Preview image</span>' +
                                                    '<img class="img img-thumbnail" id="avt-upload-preview">' +
                                                '</div>' +
                                            '</div>' +
                                        '</div>' +
                                    '</div>' +
                                ...
                                '<div class="modal-footer col-md-12 col-sm-12">' +
                                    ...
                                    '<button type="button" class="btn btn-danger" onclick="return selectAvatar()">Choose</button>' +
                                '</div>' +
                            '</div>' +
                        '</div>' +
                    '</div>' +
